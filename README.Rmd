...
At its current state the pipelines in this repository should work with any set of prokaryotic genomes. Ongoing work includes tidying the repository to ensure it can be run easily on other platforms.
